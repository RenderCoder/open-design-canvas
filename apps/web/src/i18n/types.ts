...
export type Locale = 'en' | 'de' | 'zh-CN' | 'zh-TW' | 'pt-BR' | 'es-ES' | 'ru' | 'fa' | 'tr' | 'ja' | 'ko';

export const LOCALES: Locale[] = ['en', 'de', 'zh-CN', 'zh-TW', 'pt-BR', 'es-ES', 'ru', 'fa', 'tr', 'ja', 'ko'];
...
export interface Dict {
  ...
  'figmaWizard.kicker': string;
  'figmaWizard.title': string;
  'figmaWizard.subtitle': string;
  'figmaWizard.readyBadge': string;
  'figmaWizard.needsCheckBadge': string;
  'figmaWizard.target': string;
  'figmaWizard.lastChecked': string;
  'figmaWizard.stepCodex': string;
  'figmaWizard.stepCodexBody': string;
  'figmaWizard.stepMcp': string;
  'figmaWizard.stepMcpBody': string;
  'figmaWizard.stepAuth': string;
  'figmaWizard.stepAuthBody': string;
  'figmaWizard.stepRead': string;
  'figmaWizard.stepReadBody': string;
  'figmaWizard.stepWrite': string;
  'figmaWizard.stepWriteBody': string;
  'figmaWizard.stepReady': string;
  ...
  'figmaWizard.blockedTarget': string;
  'figmaWizard.blockedRead': string;
  'figmaWizard.blockedWrite': string;
  'figmaWizard.blockedRetry': string;
  'figmaWizard.blockedWriteProbe': string;
  'figmaWizard.details': string;
  'figmaWizard.sendBlocked': string;
  'figmaWizard.sendBlockedTitle': string;
