...
export const zhCN: Dict = {
  ...
  'chat.figmaTargetTitle': 'Figma 目标',
  'chat.figmaTarget': 'Figma',
  'chat.figmaTargetUnset': '未设置',
  'chat.figmaTargetExisting': '文件链接',
  'chat.figmaTargetNewFile': '新文件',
  'figmaWizard.kicker': 'Figma MCP',
  'figmaWizard.title': '授权与写权限检查',
  'figmaWizard.subtitle':
    '生成前先检查 Codex、Figma MCP、登录状态、文件读取和编辑权限。',
  'figmaWizard.readyBadge': '已就绪',
  'figmaWizard.needsCheckBadge': '需要检查',
  'figmaWizard.target': '目标',
  'figmaWizard.lastChecked': '检查时间 {time}',
  'figmaWizard.stepCodex': 'Codex CLI',
  'figmaWizard.stepCodexBody': '本机 Codex 可以运行 MCP 命令。',
  'figmaWizard.stepMcp': 'Figma MCP',
  'figmaWizard.stepMcpBody': '已添加官方 Figma MCP 服务地址。',
  'figmaWizard.stepAuth': 'Figma 登录',
  'figmaWizard.stepAuthBody': '你的 Figma 账号已允许 MCP 访问。',
  'figmaWizard.stepRead': '文件读取',
  'figmaWizard.stepReadBody': '系统可以读取你选择的 Figma 文件或目标。',
  'figmaWizard.stepWrite': '写入权限',
  'figmaWizard.stepWriteBody': '用一个很小的 ODC MCP Probe 画框确认可编辑。',
  'figmaWizard.stepReady': '可以生成',
  ...
  'figmaWizard.blockedMcp':
    'Figma MCP 还没有正确配置。点击“准备配置”，复制命令执行后再重新检查。',
  'figmaWizard.blockedAuth':
    '需要授权 Figma。点击“授权 Figma”，在浏览器里完成登录后再重新检查。',
  'figmaWizard.blockedTarget':
    '请先选择有效的 Figma 文件链接、选区链接，或新建文件目标。',
  'figmaWizard.blockedRead':
    '当前账号不能读取这个 Figma 文件。请申请访问权限，或换一个目标。',
  'figmaWizard.blockedWrite':
    '当前账号可以读取文件，但没有编辑权限。请先申请编辑权限再生成。',
  'figmaWizard.blockedRetry':
    '这次检查失败了，但可以重试。请确认目标和 Figma 登录状态后再试一次。',
  'figmaWizard.blockedWriteProbe':
    '请先运行写权限检查，再开始 Figma-native 生成。',
  'figmaWizard.details': '开发者详情',
  'figmaWizard.sendBlocked': '先完成 Figma 检查',
  'figmaWizard.sendBlockedTitle':
    '生成前需要先完成 Figma 授权和写权限检查。',
