...
export const ru: Dict = {
  ...
  'newproj.figmaTitle': 'New Figma canvas',
  'newproj.figmaTargetLabel': 'Figma target',
  'newproj.figmaTargetHelp': 'Save an existing Figma URL or create-new-file intent before the Figma-native run. No network check is required here.',
  'newproj.figmaMcpDocs': 'MCP setup',
  'newproj.figmaModeExistingFile': 'Existing file',
  'newproj.figmaModeExistingFileHint': 'Add or update a page in a file',
  'newproj.figmaModeSelection': 'Existing selection',
  'newproj.figmaModeSelectionHint': 'Target a selected frame or node',
  'newproj.figmaModeNewFile': 'Create new file',
  'newproj.figmaModeNewFileHint': 'Let Figma MCP create the canvas',
  'newproj.figmaUrlLabel': 'Figma URL',
  'newproj.figmaUrlPlaceholder': 'https://www.figma.com/design/...',
  'newproj.figmaUrlInvalid': 'Use a figma.com design, file, board, or proto URL.',
  'newproj.figmaNodeLabel': 'Node ID',
  'newproj.figmaNodePlaceholder': 'Optional, e.g. 123:456',
  'newproj.figmaPageLabel': 'Page',
  'newproj.figmaPagePlaceholder': 'AI exploration',
  'newproj.figmaFrameLabel': 'Root frame',
  'newproj.figmaFramePlaceholder': 'Landing / Desktop / 1440',
  'newproj.figmaPlanKeyLabel': 'Figma plan key',
  'newproj.figmaPlanKeyPlaceholder': 'Optional team:: or org:: key',
  'newproj.figmaDesignSystemLabel': 'Design system: {name}',
  'newproj.figmaDesignSystemNone': 'none selected',
  'newproj.figmaPreferReuse': 'Prefer components, variables, and styles',
  'newproj.figmaAllowPrimitives': 'Allow primitive fallback when components are missing',
  ...
  'chat.figmaTargetTitle': 'Figma target',
  'chat.figmaTarget': 'Figma',
  'chat.figmaTargetUnset': 'unset',
  'chat.figmaTargetExisting': 'file URL',
  'chat.figmaTargetNewFile': 'new file',
  'figmaWizard.kicker': 'Figma MCP',
  'figmaWizard.title': 'Authorization and write check',
  'figmaWizard.subtitle': 'Verify Codex, Figma MCP, login, file access, and edit permission before writing to Figma.',
  'figmaWizard.readyBadge': 'Ready',
  'figmaWizard.needsCheckBadge': 'Needs check',
  'figmaWizard.target': 'Target',
  'figmaWizard.lastChecked': 'Checked {time}',
  'figmaWizard.stepCodex': 'Codex CLI',
  'figmaWizard.stepCodexBody': 'Local Codex can run MCP commands.',
  'figmaWizard.stepMcp': 'Figma MCP',
  'figmaWizard.stepMcpBody': 'The Figma MCP server is added with the official URL.',
  'figmaWizard.stepAuth': 'Figma login',
  'figmaWizard.stepAuthBody': 'Your Figma account is connected for MCP access.',
  'figmaWizard.stepRead': 'File access',
  'figmaWizard.stepReadBody': 'The selected file or target can be read.',
  'figmaWizard.stepWrite': 'Write permission',
  'figmaWizard.stepWriteBody': 'A tiny ODC MCP Probe frame confirms edit access.',
  'figmaWizard.stepReady': 'Ready to generate',
  'figmaWizard.stepReadyBody': 'Figma-native generation can write to this target.',
  'figmaWizard.probeSummary': 'Write probe passed on {name}.',
  'figmaWizard.writeProbeNotice': 'Write check creates or updates one tiny frame named ODC MCP Write Probe on the ODC MCP Probe page only to verify edit access.',
  'figmaWizard.probeCleanup': 'Cleanup: delete only the ODC MCP Probe page or ODC MCP Write Probe frame after checks finish.',
  ...
  'figmaWizard.blockedCodex': 'Codex CLI is not available yet. Install or open Codex before checking Figma access.',
  'figmaWizard.blockedMcp': 'Figma MCP is not configured correctly. Use Prepare setup, copy the command, then recheck.',
  'figmaWizard.blockedAuth': 'Figma needs authorization. Click Authorize Figma, finish the browser login, then recheck.',
  'figmaWizard.blockedTarget': 'Choose a valid Figma file URL, selection URL, or new-file target before continuing.',
  'figmaWizard.blockedRead': 'This account cannot read the target file. Ask for file access or choose another target.',
  'figmaWizard.blockedWrite': 'This account can read the file but cannot edit it. Ask for edit access before generation.',
  'figmaWizard.blockedRetry': 'The check failed in a recoverable way. Retry after confirming the target and Figma login.',
  'figmaWizard.blockedWriteProbe': 'Run the write permission check before starting Figma-native generation.',
  'figmaWizard.details': 'Developer details',
  'figmaWizard.sendBlocked': 'Complete Figma check',
  'figmaWizard.sendBlockedTitle': 'Run the Figma authorization and write permission check before generating.',
