...
export const en: Dict = {
  ...
  'newproj.figmaTargetHelp':
    'Save an existing Figma URL or create-new-file intent before the Figma-native run. No network check is required here.',
  ...
  'figmaWizard.subtitle':
    'Verify Codex, Figma MCP, login, file access, and edit permission before writing to Figma.',
  ...
  'figmaWizard.writeProbeNotice':
    'Write check creates or updates one tiny frame named ODC MCP Write Probe on the ODC MCP Probe page only to verify edit access.',
  'figmaWizard.probeCleanup':
    'Cleanup: delete only the ODC MCP Probe page or ODC MCP Write Probe frame after checks finish.',
  ...
  'figmaWizard.blockedMcp':
    'Figma MCP is not configured correctly. Use Prepare setup, copy the command, then recheck.',
  'figmaWizard.blockedAuth':
    'Figma needs authorization. Click Authorize Figma, finish the browser login, then recheck.',
  'figmaWizard.blockedTarget':
    'Choose a valid Figma file URL, selection URL, or new-file target before continuing.',
  'figmaWizard.blockedRead':
    'This account cannot read the target file. Ask for file access or choose another target.',
  'figmaWizard.blockedWrite':
    'This account can read the file but cannot edit it. Ask for edit access before generation.',
  'figmaWizard.blockedRetry':
    'The check failed in a recoverable way. Retry after confirming the target and Figma login.',
  'figmaWizard.blockedWriteProbe':
    'Run the write permission check before starting Figma-native generation.',
  'figmaWizard.details': 'Developer details',
  'figmaWizard.sendBlocked': 'Complete Figma check',
  'figmaWizard.sendBlockedTitle':
    'Run the Figma authorization and write permission check before generating.',
