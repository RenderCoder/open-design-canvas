#!/usr/bin/env bash
# Run the Open Design Canvas bootstrap prompt with Codex.
...
LOG=".ai/figma-codex/logs/codex-bootstrap-$(date +%Y%m%d-%H%M%S).jsonl"
PROMPT_FILE=".ai/figma-codex/prompts/bootstrap.md"
